...
from metaevobox.environment.parallelenv.parallelenv import ParallelEnv
import json
import torch
import gym, os
...
class BBO_TestUnit():
    ...
    def run_batch_episode(self):
        ...
        initual_pop = self.optimizer.particles['current_position']
