...
from metaevobox.environment.problem.SOO.COCO_BBOB.bbob_dataset import BBOB_Dataset
from metaevobox.environment.problem.SOO.COCO_BBOB.bbob_surrogate import bbob_surrogate_Dataset
from metaevobox.environment.problem.SOO.CEC2013LSGO.cec2013lsgo_dataset import CEC2013LSGO_Dataset
from metaevobox.environment.problem.SOO.UAV.uav_dataset import UAV_Dataset
from metaevobox.environment.problem.SOO.PROTEIN_DOCKING.protein_docking_dataset import Protein_Docking_Dataset
from metaevobox.environment.problem.SOO.HPO_B.hpob_dataset import HPOB_Dataset
from metaevobox.environment.problem.MOO.UAV.uav_dataset import UAV_Dataset as MMO_UAV_Dataset
...
def get_problem_set(config, problem, difficulty, train_list, test_list):
    if problem in ['bbob-10D', 'bbob-30D', 'bbob-torch-10D', 'bbob-torch-30D',
                   'bbob-noisy-10D', 'bbob-noisy-30D', 'bbob-noisy-torch-10D']:
        ...
        from metaevobox.environment.problem.SOO.NE.ne_dataset import NE_Dataset
        ...
        return CEC2013MMO_Dataset.get_datasets(
                                            ...
                                            user_test_list=test_list,
                                            version='torch' if 'torch' in problem else 'numpy')
    elif problem in ['mmo-noise']:
        return CEC2013MMO_noise_Dataset.get_datasets(train_batch_size = config.train_batch_size,
                                                     test_batch_size=config.test_batch_size,
                                                     difficulty=difficulty,
                                                     user_train_list=train_list,
                                                     user_test_list=test_list,
